...
internal sealed class TenantPrincipalCommandTestHost : IDisposable
{
    private readonly ServiceProvider _provider;

    public TenantPrincipalCommandTestHost(Queue<Func<HttpRequestMessage, HttpResponseMessage>> handlers)
    {
    ...
    private static ResolvedProfileContext TestContext() => new(
        ...
        new Connection { Id = "conn", Provider = ProviderKind.Dataverse, Cloud = CloudInstance.Public, TenantId = "tenant-id", EnvironmentType = EnvironmentType.Sandbox },
