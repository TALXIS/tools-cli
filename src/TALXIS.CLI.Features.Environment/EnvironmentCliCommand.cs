...
[CliCommand(
    ...
    Children = new[] { typeof(EnvironmentListCliCommand), typeof(EnvironmentCreateCliCommand), typeof(EnvironmentUpdateCliCommand), typeof(EnvironmentDeleteCliCommand), typeof(Package.PackageCliCommand), typeof(Solution.SolutionCliCommand), typeof(Deployment.DeploymentCliCommand), typeof(Data.EnvDataCliCommand), typeof(Entity.EntityCliCommand), typeof(OptionSet.OptionSetCliCommand), typeof(Setting.SettingCliCommand), typeof(Connector.ConnectorCliCommand), typeof(Connection.ConnectionCliCommand), typeof(Flow.FlowCliCommand), typeof(Changeset.ChangesetCliCommand), typeof(Component.ComponentCliCommand), typeof(Publisher.PublisherCliCommand), typeof(User.UserCliCommand), typeof(ServicePrincipal.ServicePrincipalCliCommand), typeof(Team.TeamCliCommand), typeof(Role.RoleCliCommand) },
