...
[CliCommand(
    ...
    Children = new[] { typeof(EntityAttributeCreateCliCommand), typeof(EntityAttributeUpdateCliCommand), typeof(EntityAttributeDeleteCliCommand), typeof(EntityAttributeTypeCliCommand) }
)]
