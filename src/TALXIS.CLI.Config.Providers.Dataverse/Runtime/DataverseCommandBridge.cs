...
public static class DataverseCommandBridge
{
    ...
    private static void ValidateDataverseProfile(Model.Connection connection)
    {
    ...
    private static Uri ParseEnvironmentUrl(Model.Connection connection)
    {
    ...
    public sealed record PrimedProfile(Model.Connection Connection, Credential Credential, Uri EnvironmentUrl);
}
